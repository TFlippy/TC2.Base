...
namespace TC2.Base.Components
{
	public static partial class Paxilon
	{
		...
		{
			[Statistics.Info("Amount", description: "Amount of paxilon hydrochlorate released over the total duration.", format: "{0:0.##} mg", comparison: Statistics.Comparison.None, priority: Statistics.Priority.High)]
			public float amount;
