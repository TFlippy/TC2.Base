...
namespace TC2.Base.Components
{
	public static partial class Codeine
	{
		...
		{
			[Statistics.Info("Amount", description: "Amount of codeine released over the total duration.", format: "{0:0.##} mg", comparison: Statistics.Comparison.None, priority: Statistics.Priority.High)]
			public float amount;
