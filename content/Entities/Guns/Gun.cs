...
namespace TC2.Base.Components
{
	public static partial class Gun
	{
		...
		public static void GEN_SetupGunRecipe(ref this IRecipe.Data recipe, float ratio_grip, float ratio_receiver, float ratio_barrel, SetupGunFlags flags = SetupGunFlags.None)
		{
			try
			{
				...
				//if (recipe.stages.IsNullOrEmpty() || flags.HasAll(SetupGunFlags.New | SetupGunFlags.Overwrite))
				{
					...
					prd_main.flags = Crafting.Product.Flags.Primary | Crafting.Product.Flags.Compact;
		...
		[Source.Owned, Pair.Component<Gun.Data>] ref Inventory1.Data inventory_magazine)
		{
			...
			gun_state.hints.SetFlag(Gun.Hints.Long_Range, (gun.heuristic_range > 15.00f && (gun_state.hints.HasAny(Hints.Artillery) || (gun.velocity_multiplier.NormalizeFastUnsafe(1.00f + gun.jitter_multiplier) > 150.00f))));
