...
{
	public static partial class Electrochamber
	{
		...
		public struct Data(): IComponent
		{
			...
			public Electrochamber.Data.Flags flags;
		...
		public static void OnUpdate(ISystem.Info info, ref XorRandom random, ref Region.Data region, Entity ent_electrochamber,
		[Source.Owned] in Transform.Data transform, [Source.Owned] ref Electrochamber.Data electrochamber,
		...
		public static void OnUpdate_Essence(ISystem.Info info, ref XorRandom random, ref Region.Data region, Entity ent_electrochamber,
		[Source.Owned] in Transform.Data transform,
		[Source.Owned] ref Electrochamber.Data electrochamber, [Source.Owned] ref Essence.Emitter.Data essence_emitter)
		{
			if (essence_emitter.state_flags.HasAny(Essence.Emitter.StateFlags.Pulsed))
			{
				...
				if (essence_data.IsNotNull())
				{
					...
					Sound.Play(region: ref region, h_soundmix: essence_emitter.h_soundmix_pulse, random: ref random, pos: pos, size: 1.00f, dist_mult: 0.50f); //, volume: 1.00f, pitch: 1.00f, size: 0.35f, dist_multiplier: 0.65f);
		...
		public static void OnPreUpdate(ISystem.Info info, ref XorRandom random, ref Region.Data region, Entity ent_electrochamber,
		[Source.Owned] in Transform.Data transform,
		[Source.Owned] ref Electrochamber.Data electrochamber,
...
#if CLIENT
		public struct ElectrochamberGUI: IGUICommand
		{
			public Entity ent_electrochamber;

			public Transform.Data transform;
			public Crafter.Data crafter;
			public Crafter.State crafter_state;
			public Electrochamber.Data electrochamber;

			public void Draw()
			{
				using (var window = GUI.Window.InteractionMisc("Electrochamber"u8, this.ent_electrochamber, size: new(48 * 3, 96 * 1)))
				{
		...
		[Source.Owned] in Electrochamber.Data electrochamber)
		{
			if (interactable.IsActive())
			{
				var gui = new ElectrochamberGUI()
				{
					ent_electrochamber = entity,

					transform = transform,
					crafter = crafter,
					crafter_state = crafter_state,
					electrochamber = electrochamber
				};
				gui.Submit();
			}
		}
