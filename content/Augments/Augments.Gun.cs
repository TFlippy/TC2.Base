						...
						switch (requirement.type)
						{
							...
							case Crafting.Requirement.Type.Work:
							{
								switch (requirement.work.GetIdentifier())
								{
									case "smithing":
									{
										context.requirements_new.Merge(Crafting.Requirement.Work(requirement.work, 50.00f * amount, (byte)MathF.Ceiling(5.00f * amount)));
									}
									break;
								}
							}
						...
						else if (requirement.type == Crafting.Requirement.Type.Work)
						{
							switch (requirement.work.GetIdentifier())
							{
								case "machining":
								{
									...
									context.requirements_new.Merge(requirement);
								}
								break;
			...
			(
				...
				apply_1: static (ref Augment.Context context, ref Gun.Data data, ref Augment.Handle handle, Span<Augment.Handle> augments) =>
				{
					...
					if (essence_data.IsNotNull())
					{
						...
						context.requirements_new.Merge(Crafting.Requirement.Resource("smirgrafit.compacted", smirglum_count).WithFlags(Crafting.Requirement.Flags.Prerequisite | Crafting.Requirement.Flags.Compact), ref mass_added);
